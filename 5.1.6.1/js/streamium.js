// jQuery(document).ready(_page_reload);
    ...
    return d(window).scroll(d.throttle(250, b)), d(".subscriptio_list_product a").contents().unwrap(), d(".product-name a").contents().unwrap(), d(".subscriptio_frontend_items_list_item a").contents().unwrap(), d(".subscriptio_list_id a").contents().unwrap(), d(".product-thumbnail").remove(), d(".widget > ul").addClass("list-group"), d(".widget > ul > li").addClass("list-group-item"), d(".widget").fadeIn(), {
        ...
        recentTemplate: function(a, b) {
            ...
            j.slick(this.slick), j.find(".slick-prev").addClass("hidden"), j.on("setPosition", function(a, b, c) {
                d(this).find(".slick-active:first").addClass("far-left"), b.slideCount > 6 && d(this).find(".slick-active:last").addClass("far-right"), d(".lazy").Lazy(e.lazy),window._bLazy &&  window._bLazy.revalidate()
		...
		_url = [streamium_object.ajax_url, a.action, a.post_id].join('/') + '.json';
		    ...
		    b.cat = a.cat;
                    ...
                    var f = "." + b.cat,
                        ...
                        i = "#tile-white-selected-" + b.cat + "-" + a.post_id,
                        j = b.title,
                        k = d(f).width(),
                        l = Math.floor(k / 21 * 8);
		    ...
		    ,"" === b.trailer ? d(f).find("a.synopis-video-trailer").hide() : d(f).find("a.synopis-video-trailer").fadeIn().attr("href", b.href + "?trailer=true");
                    ...
                    d("html, body").animate({
                        ...
                        d(f + " .s3bubble-details-inner-content").animate({
                            opacity: 1
                        }, 500, function() {}), d(i).show(), d(i).addClass("tile-white-is-selected"), d('[data-toggle="tooltip"]').tooltip()
                    });
                    ...
                    c.getData({
                        ...
                        if (Object.keys(b).length > 0)
                            for (var k = 0; k < Object.keys(b).length; k++) {
                                var l = b[k + 1];
                                if (l.length > 0)
                        ...
                        d(h).fadeIn(), d(f).find("h4.series-watched-episode-title").text(j + " Episodes"), !1 === d(g).hasClass("slick-initialized") && (p.html(e), d(g).slick(c.slickSeries), d(g).on("setPosition", function(a, b, e) {
                            d(".lazy").Lazy(c.lazy),window._bLazy &&  window._bLazy.revalidate()
                        }), d(".lazy").Lazy(c.lazy),window._bLazy &&  window._bLazy.revalidate());
            ...
            if (g.length > 0)
                for (a = 0; a < g.length; a++) {
                    ...
                    o.slick(this.slick), o.find(".slick-prev").addClass("hidden"), o.on("setPosition", function(a, b, c) {
                        d(this).find(".slick-active:first").addClass("far-left"), b.slideCount > 6 && d(this).find(".slick-active:last").addClass("far-right"), d(".lazy").Lazy(f.lazy),window._bLazy &&  window._bLazy.revalidate()
		...
		a(".streamium-slider").on('afterChange', function() {
		    ...
		    // });
                ...
                c.isMobile.any() && (h = "tile"), a("body").on("click", "." + h, function (b) {
                    ...
                    a(".series-watched").fadeOut(), a(".tile-white-selected").hide(), c.animate({
                        opacity: 0
                    }, 250, function () {
                        c.parent().animate({
                            height: 0
                    ...
                    c.homeTemplate(b, function () {
                        ...
                        a(".video-header").height(b), a(".streamium-loading").fadeOut(), a(".lazy").Lazy(c.lazy),window._bLazy &&  window._bLazy.revalidate()
                    })
                    ...
                    b.id = "tax-watched", c.staticTemplate(b, function () {
                        ...
                        a(".static-row").css("margin-top", b + "px"), a(".lazy").Lazy(c.lazy), window._bLazy &&  window._bLazy.revalidate()
                    })
        ...
        _page_ready(function (a) {
            ...
            e(), a(window).on("resize", function () {
                ...
                if (e.next("ul").hasClass("is-hidden")) {
                    ...
                    a("#" + f).animate({
                        height: 30 * g
                    }, 200), e.parent(".has-children").siblings(".has-children").children("ul").addClass("is-hidden").end().children("a").removeClass("selected"), a(".cd-overlay").addClass("is-visible")
                } else a("#" + f).animate({
                    height: 0
                }, 200), a("#" + f).css("height", "auto"), e.removeClass("selected").next("ul").addClass("is-hidden").end().parent(".has-children").parent("ul").removeClass("moves-out"), a(".cd-overlay").removeClass("is-visible");
                c("close")
                    ...
                    b.on("timeupdate", function () {
                        ...
                        function b() {
                            var _data = {
                                ...
                                _url = [streamium_object.ajax_url, 'api', _data.action].join('/') + '.json';
